# Chrome (window chrome & global UI)

## Done

- [x] Status bar: model, mode, chat count, token estimate
- [x] Global shortcuts: Cmd+N new chat, Cmd+B sidebar, Cmd+J agents, Cmd+K palette, Cmd+Shift+Backspace delete chat, Cmd+1..9 switch chat
- [x] Command palette (Cmd+K) with actions
